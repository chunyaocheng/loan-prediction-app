...
# 載入主檔案與加減碼檔案
file_path_main = "/Users/zhengqunyao/machine_learning_v32.xlsx"  # 主檔案
...
# 將加減碼資料針對案件編號取最大動撥金額所對應的加減碼
addon_max_df = addon_df.loc[
    addon_df.groupby('案件編號')['動撥金額'].idxmax(), ['案件編號', '加減碼']
]
...
# 儲存結果到新的檔案
output_file = "/Users/zhengqunyao/machine_learning_v34.xlsx"
